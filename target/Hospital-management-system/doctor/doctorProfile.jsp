...
<div class="container-fluid" style="padding-top:50px">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <%@ include file="doctorProfileView.jsp" %>
            <%--<h1> Room assigned</h1>
                                <br/>
                                <%
                                    String r=result1.getString("emloyeeID");
                                    if(r=="null"){
                                %>
                                    <a href="assignRoom.jsp?id=<%=result1.getString("employeeId") %>" > <button type="button" class="btn btn-primary">assign room</button></a>
                                <%
                                }
                                else {
                                %>
                                    <span class="label label-success"><%=result1.getString("roomAssigned") %></span>
                                <%
                                    }
                                %>

                                <%=result1.getString("room")%>--%>
